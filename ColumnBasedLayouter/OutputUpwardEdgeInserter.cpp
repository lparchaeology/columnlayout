...
Module::ReturnType OutputUpwardEdgeInserter::doCall(UpwardPlanRep &UPR,
...
void OutputUpwardEdgeInserter::staticLock(ogdf::UpwardPlanRep &UPR, 
...
void OutputUpwardEdgeInserter::getPath(UpwardPlanRep &UPR,
										  List<edge> &origEdges,
										 EdgeArray<int> &cost, 
										  edge e_orig,
										  SList<adjEntry> &path,
...
bool OutputUpwardEdgeInserter::isConstraintFeasible(ogdf::UpwardPlanRep &UPR, 
...
bool OutputUpwardEdgeInserter::isConstraintFeasible(UpwardPlanRep &UPR,
							List<edge> &origEdges,	
							edge e_orig,
							SList<adjEntry> &path)
{	
...
void OutputUpwardEdgeInserter::feasibleEdges(ogdf::UpwardPlanRep &UPR,
												  ogdf::face f, 
												  ogdf::adjEntry adj, 
												  ogdf::EdgeArray<bool> &locked, 
...
void OutputUpwardEdgeInserter::markUp(const Graph &G, node v, 
...
void OutputUpwardEdgeInserter::markDown(const Graph &G, node v, 
											//NodeArray<bool> &markedNodes, 
											EdgeArray<bool> &markedEdges) {		
